...
class CalendarFragmentTest {
    ...
    @Before
    fun setUp() {
        scenario = launchFragmentInContainer<CalendarFragment>()
    }
    ...
    @Test
    fun calendarFragment_displaysInitialViewsCorrectly() {
        ...
        onView(withId(R.id.itemsRecyclerView)).check(matches(isDisplayed()))
